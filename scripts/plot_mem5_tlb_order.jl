...
function load_all(dir)
    regex = r"/test_mem_(load|store)5_(page|dense)_regular_([0-9]*)_summary_fit.csv$"
...
const prefix = joinpath(@__DIR__, "../imgs/mem5_tlb_order")
...
tight_layout()
NaCsPlot.maybe_save("$(prefix)_load_l1l2")
...
tight_layout()
NaCsPlot.maybe_save("$(prefix)_store_l1l2")
