...
function load_all(dir)
    regex = r"/test_mem_(load|store)6_(page|dense)_randomize_([0-9]*)_summary_fit.csv$"
...
const prefix = joinpath(@__DIR__, "../imgs/mem6_tlb")
...
const fit_ice_load8 = fit_data(model_miss, sizes, ice_evt_diff[8], [1024.0])
...
const fit_fire_load8 = fit_data(model_miss, sizes, fire_evt_diff[8], [3072.0])
...
plot(sizes, ice_evt_diff[8], "C1.", label="8")
plot(fit_ice_load8.plotx, fit_ice_load8.ploty, "C1")
plot(sizes, ice_evt_diff[11], "C2.", label="11")
plot(fit_ice_load11.plotx, fit_ice_load11.ploty, "C2")
plot(sizes, ice_evt_diff[193], "C3.", label="193")
plot(fit_ice_load193.plotx, fit_ice_load193.ploty, "C3")
text(200, 0.3, "TLB_L1=$(fit_ice_load5.uncs[1])", color="C0", fontsize=10)
text(200, 0.2, "TLB_L1=$(fit_ice_load193.uncs[1])", color="C3", fontsize=10)
text(1800, 0.2, "TLB_L2=$(fit_ice_load8.uncs[1])", color="C1", fontsize=10)
text(1800, 0.3, "TLB_L2=$(fit_ice_load11.uncs[1])", color="C2", fontsize=10)
axvline(128, color="r")
axvline(1024, color="g")
gca()[:set_xscale]("log")
xlim([64, 32 * 256])
...
plot(sizes, fire_evt_diff[8], "C1.", label="8")
plot(fit_fire_load8.plotx, fit_fire_load8.ploty, "C1")
plot(sizes, fire_evt_diff[11], "C2.", label="11")
plot(fit_fire_load11.plotx, fit_fire_load11.ploty, "C2")
plot(sizes, fire_evt_diff[193], "C3.", label="193")
plot(fit_fire_load193.plotx, fit_fire_load193.ploty, "C3")
text(200, 0.3, "TLB_L1=$(fit_fire_load5.uncs[1])", color="C0", fontsize=10)
text(200, 0.2, "TLB_L1=$(fit_fire_load193.uncs[1])", color="C3", fontsize=10)
text(1800, 0.2, "TLB_L2=$(fit_fire_load8.uncs[1])", color="C1", fontsize=10)
text(1800, 0.3, "TLB_L2=$(fit_fire_load11.uncs[1])", color="C2", fontsize=10)
axvline(160, color="r")
axvline(3072, color="g")
gca()[:set_xscale]("log")
xlim([64, 32 * 256])
...
const fit_ice_store8 = fit_data(model_miss, sizes, ice_evt_diff[8], [1024.0])
...
const fit_fire_store8 = fit_data(model_miss, sizes, fire_evt_diff[8], [3072.0])
...
plot(sizes, ice_evt_diff[8], "C1.", label="8")
plot(fit_ice_store8.plotx, fit_ice_store8.ploty, "C1")
plot(sizes, ice_evt_diff[11], "C2.", label="11")
plot(fit_ice_store11.plotx, fit_ice_store11.ploty, "C2")
plot(sizes, ice_evt_diff[193], "C3.", label="193")
plot(fit_ice_store193.plotx, fit_ice_store193.ploty, "C3")
text(200, 0.3, "TLB_L1=$(fit_ice_store5.uncs[1])", color="C0", fontsize=10)
text(200, 0.2, "TLB_L1=$(fit_ice_store193.uncs[1])", color="C3", fontsize=10)
text(1800, 0.2, "TLB_L2=$(fit_ice_store8.uncs[1])", color="C1", fontsize=10)
text(1800, 0.3, "TLB_L2=$(fit_ice_store11.uncs[1])", color="C2", fontsize=10)
axvline(128, color="r")
axvline(1024, color="g")
gca()[:set_xscale]("log")
xlim([64, 32 * 256])
...
plot(sizes, fire_evt_diff[8], "C1.", label="8")
plot(fit_fire_store8.plotx, fit_fire_store8.ploty, "C1")
plot(sizes, fire_evt_diff[11], "C2.", label="11")
plot(fit_fire_store11.plotx, fit_fire_store11.ploty, "C2")
plot(sizes, fire_evt_diff[193], "C3.", label="193")
plot(fit_fire_store193.plotx, fit_fire_store193.ploty, "C3")
text(200, 0.3, "TLB_L1=$(fit_fire_store5.uncs[1])", color="C0", fontsize=10)
text(200, 0.2, "TLB_L1=$(fit_fire_store193.uncs[1])", color="C3", fontsize=10)
text(1800, 0.2, "TLB_L2=$(fit_fire_store8.uncs[1])", color="C1", fontsize=10)
text(1800, 0.3, "TLB_L2=$(fit_fire_store11.uncs[1])", color="C2", fontsize=10)
axvline(160, color="r")
axvline(3072, color="g")
gca()[:set_xscale]("log")
xlim([64, 32 * 256])
